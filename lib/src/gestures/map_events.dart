...
class MapEventMoveStart extends MapEvent {
  MapEventMoveStart({required MapEventSource source, required LatLng center, required double zoom})
      : super(source: source, center: center, zoom: zoom);
}

class MapEventMoveEnd extends MapEvent {
  MapEventMoveEnd({required MapEventSource source, required LatLng center, required double zoom})
      : super(source: source, center: center, zoom: zoom);
}
...
class MapEventFlingAnimationNotStarted extends MapEvent {
  MapEventFlingAnimationNotStarted(
      {required MapEventSource source, required LatLng center, required double zoom})
      : super(source: source, center: center, zoom: zoom);
}
...
class MapEventRotateEnd extends MapEvent {
  MapEventRotateEnd({required MapEventSource source, required LatLng center, required double zoom})
      : super(source: source, center: center, zoom: zoom);
}